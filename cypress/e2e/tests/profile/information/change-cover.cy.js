...
describe('Change cover', () => {
    ...
    it.skip('Add user cover', () => {
        ...
        ProfileSettingsMethods.changeCoverPicture(AccountSettingsData.accountData.cover)
    ...
    it('Update user cover', () => {
        ...
        Logger.stepNumber(6)
        Logger.step('Subimos la foto de portada')
        ProfileSettingsMethods.changeCoverPicture(AccountSettingsData.accountData.newCover)
    ...
    it('Remove user cover', () => {
        ...
        cy.intercept('POST', CommonPageData.endPoints.deleteCover).as('deleteCover')
