...
export class RegisterMethods {
    ...
    static clickAcceptTermsAndConditionsCheckbox() {
        RegisterElements.textBoxes.checkboxAcceptTermsAndConditions.click()
    }
    ...
    static signUp(username, email, password, confirmPassword, birthDate) {
        ...
        Logger.subStep('Aceptar terminos y condiciones')
        this.clickAcceptTermsAndConditionsCheckbox()
